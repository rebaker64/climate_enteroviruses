...
require("scales")
require("tidyr")
includevar =TRUE # whether to include variability
...
int$province <- "years"
intlist <- c(c("int","temp","schl"), prov_list[2:15],"Japan",prov_list[16:31])
...
temphistoric <- sumclim$temp.mean
tempfuture <- sumclim$temp.mean + sumclim$tempchange.mean
